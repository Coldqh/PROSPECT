...
if ! grep -q '"version": "0.32.0"' "$ROOT/package.json"; then
  printf 'Patch files were not copied completely. Expected package version 0.32.0.\n' >&2
  exit 1
fi
...
printf 'PROSPECT 0.32.0 FOOTBALL KERNEL applied.\nRun: npm run dev\n'
