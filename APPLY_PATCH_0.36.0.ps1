...
if ($Version -ne "0.36.0") {
  throw "Patch files were not copied completely. Expected package version 0.36.0, found $Version."
}
...
Write-Host "PROSPECT 0.36.0 MATCH EXPERIENCE REBUILD applied."
