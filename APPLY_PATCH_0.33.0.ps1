...
if ($Version -ne "0.33.0") {
  throw "Patch files were not copied completely. Expected package version 0.33.0, found $Version."
}
...
Write-Host "PROSPECT 0.33.0 ECOSYSTEM VISIBILITY applied."
