...
if ($Version -ne "0.35.0") {
  throw "Patch files were not copied completely. Expected package version 0.35.0, found $Version."
}
...
Write-Host "PROSPECT 0.35.0 ALL PLAYABLE POSITIONS applied."
