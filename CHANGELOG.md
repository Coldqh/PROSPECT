...
## 0.33.0 — ECOSYSTEM VISIBILITY

### Мир стал наблюдаемым

- добавлен единый экран рынка игроков, трансферов, коммитов и тренерских переходов;
- школьная и колледжная карьера используют один раздел рынка;
- трансферные решения и предложения героя показаны внутри общего рынка без отдельной параллельной системы;
- профиль программы получил трёхлетний план состава, позиционные потребности, переговоры и открытые места;
- профиль программы получил архив сезонов, входящие и исходящие движения и историю транзакций;
- данные рынка открывают существующие профили игроков и программ;
- добавлены selectors для командного среза, рынка игроков, тренерской карусели и позиционного давления;
- внутренние статусы, роли, стратегии и стипендии локализованы;
- удалены старые неиспользуемые `simulateCollegeTeams`, `chooseCommitment`, `simulateRecruitingMarket` и `processTransfers`;
- версия приложения и PWA повышена до `0.33.0`.
...
- ecosystem visibility architecture — PASS;
- синтаксический прогон 137 TypeScript/TSX-файлов — PASS;
- strict TypeScript-проверка нового слоя видимости — PASS.
