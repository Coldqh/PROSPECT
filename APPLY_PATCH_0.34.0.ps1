...
if ($Version -ne "0.34.0") {
  throw "Patch files were not copied completely. Expected package version 0.34.0, found $Version."
}
...
Write-Host "PROSPECT 0.34.0 FULL FOOTBALL ROSTERS applied."
