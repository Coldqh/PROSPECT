...
if ($Version -ne "0.39.0") {
  throw "Patch files were not copied completely. Expected package version 0.39.0, found $Version."
}
...
Write-Host "PROSPECT 0.39.0 AUTONOMOUS PROFESSIONAL LEAGUE applied."
