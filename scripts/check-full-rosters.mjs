...
const files = {
  ...
  matchEpisodes: readFileSync("src/sports/football/matches/simulation/episodeBuilder.ts", "utf8"),
  matchContext: readFileSync("src/sports/football/matches/simulation/matchupContext.ts", "utf8"),
...
const requiredTokens = [
  ...
  ["matchEpisodes", "bindRosterToAssignments"],
  ["matchContext", "specialistForSide"],
  ["matchContext", "fieldGoalChance"],
  ["matchContext", "puntNetYards"],
