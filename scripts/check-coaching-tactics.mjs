...
const files = {
  ...
  proRoster: read("src/sports/football/pro/league/roster.ts"),
  proSchedule: read("src/sports/football/pro/league/schedule.ts"),
...
const required = [
  ...
  ["proRoster", "player.schemeFit * 0.12"],
  ["proSchedule", "professionalTacticalModifier(home, away)"],
