  ...
  return [
    {
      ...
      coachValue: "Главный путь к доверию позиционного тренера.",
      load: 62,
    ...
    },
    {
      ...
      coachValue: "Даёт физическое преимущество, но быстро накапливает нагрузку.",
      load: 82,
    ...
    },
    {
      ...
      summary: "Разбор ошибок, распознавание ключей соперника и установка игрового плана.",
      coachValue: "Повышает надёжность и шанс правильно выполнить задание.",
      load: 34,
    ...
    },
    {
      ...
      coachValue: "Сохраняет доступность и возвращает качество следующих тренировок.",
      load: 18,
