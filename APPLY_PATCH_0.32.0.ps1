...
if ($Version -ne "0.32.0") {
  throw "Patch files were not copied completely. Expected package version 0.32.0, found $Version."
}
...
Write-Host "PROSPECT 0.32.0 FOOTBALL KERNEL applied."
